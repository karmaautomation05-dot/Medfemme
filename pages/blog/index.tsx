        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Women's Health <span className="text-pink-600">Insights</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post) => (
              <article key={post.slug} className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden border border-pink-100 flex flex-col">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between">
                    <Link href={`/blog/${post.slug}`} className="text-pink-600 font-semibold text-sm hover:underline flex items-center">
                      Read More
