...
import { Award, GraduationCap, Building2, HeartHandshake } from 'lucide-react'
...
export default function About() {
  ...
  return (
    <>
      <SEO 
        title="About Dr. Priyanka Bhargava | Best Gynecologist in Kanpur" 
      ...
      <section className="section-padding bg-brand-50/30">
        <div className="container">
           <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl font-bold text-brand-900 uppercase tracking-widest">— Dr. Priyanka Bhargava</p>
           </div>
        </div>
      </section>
